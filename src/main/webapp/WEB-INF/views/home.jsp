            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <a href="representatives" class="btn btn-primary">Перейти</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">Управление назначением территорий представителям</p>
                        <a href="representative-territories" class="btn btn-primary">Перейти</a>
                    </div>
                </div>
            </div>
        </div>
